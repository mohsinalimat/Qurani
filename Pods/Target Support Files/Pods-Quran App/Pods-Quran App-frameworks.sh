...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GDLoadingIndicator/GDLoadingIndicator.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LUNTabBarController/LUNTabBarController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TOScrollBar/TOScrollBar.framework"
